		...
		<div class="row text-center">
			<div class="col-sm-4 card_img">
				<a href="<?=base_url('Welcome/c_login')?>">
					<div class="card log_company" style="background-image:linear-gradient(0deg, rgba(6, 6, 6, 0.61), rgba(6, 6, 6, 0.09)), url('<?php echo base_url()."assets/img/company.jpg"; ?>');height: 15vh;border-radius: 10px;background-position: center;background-size: cover;">
