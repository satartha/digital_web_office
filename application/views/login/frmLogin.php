        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <a href="<?=base_url('Welcome/admin')?>" class="auth-link text-black pull-right" style="color:#072247">Admin Login</a><br>
              <a href="<?=base_url('Welcome/user')?>" class="auth-link text-black pull-right" style="color:#072247">Click here to login as a Staff</a>
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" class="form-control form-control-lg" id="tp" name="tp" placeholder="Password">
					  <div class="input-group-append bg-transparent" style="border-right:1px solid;">
						  <span class="input-group-text bg-transparent border-right-0">
							<i class="mdi mdi-eye-off mdi-eye" id="spwd" style="color: #072247;cursor: pointer"></i>
						  </span>
					  </div>
                  </div>
                </div>
