				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
					<div class="card">
						<div class="card-header" style="background-color:#ff4f00">
							<h3 class="card-title text-white" > Admin Create Form</h3>
						</div>
						<div class="card-body">
                        <form id="frmEform2">
                                   <div class="row">
                                               ...
                                               <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                   <div class="row">
                                                       ...
                                                       <div class="form-group">
                                                               ...
                                                               <label for="gen" class="control-label mb-1">Admin Name<span style="color:red;">*</span></label>
...
<!--                                                               <input type="hidden" id="txtPersonid" name="txtPersonid" value="0" >-->
                                               ...
                                               <input type="hidden" id="txtPersonid" name="txtPersonid" value="0" >-->
                                                       ...
                                                       <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                                                           <div class="form-group">
                                                               <label for="mNo" class="control-label mb-1">Admin Number</label>
                                                       ...
                                                       <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                                                           <div class="form-group">
                                                               <label for="email" class="control-label mb-1">Admin Email id</label>
                                                       ...
                                                       <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                                                           <div class="form-group">
                                                           <label for="wNo" class="control-label mb-1">Admin Password</label>
                                                       ...
                                                       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                                           <div class="form-group">
                                                               <label for="address" class="control-label mb-1">Admin Address</label>
                                                   ...
                                                   <div class="row">
                                                       ...
                                                       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                                           <div class="form-group">
                                                               <label for="address" class="control-label mb-1">Admin Logo</label>
...
<!--									<th class="text-center">Type</th>-->
									...
									<th class="text-center">Admin Mobile</th>
