...
$cdmslogin=$this->session->dflogin;
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
					<div class="card">
						<div class="card-header" style="background-color:#ff4f00">
							<h3 class="card-title text-white" > Company Entry Form</h3>
						</div>
						<div class="card-body">
                        <form id="frmEform2">
                                   <div class="row">
                                           ...
                                           <div class="tab-content" id="myTabContent">
                                               <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                   <div class="row">
                                                       ...
                                                       <input type="hidden" id="parentid" name="parentid" value="<?php echo $cdmslogin['companyid']; ?>" class="form-control"  placeholder="Enter Your Company Name."  >
