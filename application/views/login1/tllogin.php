        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <h6 class="font-weight-light">Login as Staff <i class="mdi mdi-emoticon" style="color:#ff4f00;"></i> </h6>
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" class="form-control form-control-lg border-left-0" id="tp" name="tp" placeholder="Password">
					  <div class="input-group-append bg-transparent" style="border-right:1px solid;">
						  <span class="input-group-text bg-transparent border-right-0">
							<i class="mdi mdi-eye-off mdi-eye" id="tpwd" style="color: #ff4f00;cursor: pointer"></i>
						  </span>
					  </div>
                  </div>
                </div>
