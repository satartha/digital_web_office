                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-header" style="background-color:#ff4f00">
                            <h3 class="card-title text-white" > Workflow Form</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <input type="hidden" id="txtid" name="txtid" value="0">
                                ...
                                <div class="form-group">
                                    <label for="pn" class="control-label mb-1">Workflow Name</label>
                                    <input type="text" class="form-control" name="wfnm" id="wfnm" onclick="charachters_validate('wfnm')" placeholder="Enter Workflow Name" minlength="1" maxlength="30" required>
                                </div><br>
