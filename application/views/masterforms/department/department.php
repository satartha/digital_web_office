                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="card-header" style="background-color:#ff4f00">
                            <h3 class="card-title text-white" > Department Form</h3>
                        </div>
                        <div class="card-body">
                        
                            <form id="frmDp" enctype="multipart/form-data" method="post">
                            <input type="hidden" id="txtid" name="txtid" value="0">
                                
                                <div class="form-group">
                                    <label for="pn" class="control-label mb-1">Department Name</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="pce" class="control-label mb-1">Department Logo</label>
                                    <input type="file" class="form-control" name="dep_logo" >
                                </div>
                                <br>
